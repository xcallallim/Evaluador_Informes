"""Validator for national policy methodology files."""
...
def _validate_niveles(
    *,
    ...
    """Validate question levels ensuring structure and numeric boundaries."""
...
def validate_politica_nacional_schema(data: Dict[str, Any]) -> ValidationResult:
    """Validate the national policy methodology schema structure."""
